...
/// </summary>
public class EscortCameraManager : MonoBehaviour
{
    ...
    internal CinemachineConfiner2D mainCameraConfiner2D;

    // Awake is called when the script instance is being loaded
    private void Awake()
    {
        mainCameraTargetGroup = MainCamera.GetComponentInChildren<CinemachineTargetGroup>();
        mainCameraConfiner2D = MainCamera.GetComponentInChildren<CinemachineConfiner2D>();
    }
